...
var HelloWorldLayer5 = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        doorlayer.setAnchorPoint(cc.p(1.8,-0.3));
        ...
        wood.setAnchorPoint(cc.p(2.25,1.7));
        ...
        male.setAnchorPoint(cc.p(3.75,-1.1));
        male.setPosition(cc.p(size.width/2,size.height/2));
        this.addChild(male,1);
        var male_action = cc.Repeat.create(cc.MoveBy.create(0.15,cc.p(0,-5)),17);
        var male_action0 = cc.Repeat.create(cc.MoveBy.create(0.15,cc.p(0,0)),10);
        var male_action1 = cc.Repeat.create(cc.MoveBy.create(0.15,cc.p(0,5)),17);
       // var male_action2 = cc.FadeOut.create(.1);
        ...
        // hand.setAnchorPoint(cc.p(0.2,8));
        // hand.setPosition(cc.p(size.width/2,size.height/2));
        // this.addChild(hand,1);
        // var hand_action = cc.Repeat.create(cc.MoveBy.create(0.04,cc.p(0,5)),42);
        // var hand_action1 = cc.Repeat.create(cc.MoveBy.create(0.04,cc.p(0,-5)),42);
        // var sequence_hand = cc.Sequence.create(hand_action, hand_action1);
...
function dright()
{
    ...
    dright.setAnchorPoint(cc.p(0.5,1.1));
    dright.setPosition(cc.p(size.width/2,size.height/2));
    this.addChild(dright,1);
    var btn_action = cc.Repeat.create(cc.MoveBy.create(0.04,cc.p(1,0)),60);
...
function dleft()
{
    ...
    dleft.setAnchorPoint(cc.p(-0.8,1.1));
...
function flycoin()
{
    ...
    flycoin.setAnchorPoint(cc.p(-9,0.6));
